...
**Evaluation Date:** 2026-07-26 01:26:48  
...
| :--- | :---: | :---: | :---: |
| **Generation Speed (tokens/sec)** | **`0.00` tok/s** | `48.39` tok/s | **`-100.0%`** |
| **Prompt Eval Speed (tokens/sec)** | **`0.00` tok/s** | `47.92` tok/s | **`-100.0%`** |
| **Time to First Token (TTFT)** | **`0.0` ms** | `12390.1` ms | **`-100.0%`** |
| **Median Inter-Token Latency (p50 ITL)** | **`0.00` ms** | `20.76` ms | **`-100.0%`** |
| **p95 Inter-Token Latency** | `0.00` ms | `21.96` ms | - |
| **Total Wall Clock Duration** | **`0.00` s** | `15.03` s | **`-100.0%`** |
